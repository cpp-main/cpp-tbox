...
# LIB_VERSION_X, LIB_VERSION_Y, LIB_VERSION_Z, SRC_FILES, CXXFLAGS, TEST_LDFLAGS
#
# TARGETS:
...
OBJECTS := $(foreach src,$(SRC_FILES),$(call CPP_SOURCE_TO_OBJECT,$(src)))
...
$(foreach src,$(SRC_FILES),$(eval $(call CREATE_CPP_OBJECT,$(src))))
...
SHARED_OBJECTS := $(foreach src,$(SRC_FILES),$(call CPP_SOURCE_TO_SHARED_OBJECT,$(src)))
...
$(call C_SOURCE_TO_SHARED_OBJECT,$(1)) : $(1)
	@echo "\033[32mCXX $^\033[0m"
	@$(CC) $(SHARED_CXXFLAGS) -o $@ -c $^
endef

$(foreach src,$(SRC_FILES),$(eval $(call CREATE_CPP_SHARED_OBJECT,$(src))))
...
TEST_OBJECTS := $(foreach src,$(TEST_SRC_FILES),$(call CPP_SOURCE_TO_TEST_OBJECT,$(src)))
...
define CREATE_C_TEST_OBJECT
$(call C_SOURCE_TO_TEST_OBJECT,$(1)) : $(1)
	@echo "\033[32mCXX $^\033[0m"
	@$(CC) $(TEST_CXXFLAGS) -o $@ -c $^
endef

$(foreach src,$(TEST_SRC_FILES),$(eval $(call CREATE_CPP_TEST_OBJECT,$(src))))
