...
std::string RawDataToHexStr(const void *data_ptr,
                            uint16_t data_len,
                            bool uppercase,
...
namespace {
void _HexStrToRawDataWithDelimiter(const std::string &hex_str,
...
size_t HexStrToRawData(const std::string &hex_str,
                       std::vector<uint8_t> &out,
                       const std::string &delimiter)
{
    out.clear();
...
void Replace(std::string &target_str,
